...
public class CompraVentaIvaController implements ActionListener {
    ...
    public CompraVentaIva newCompraVenta() throws ParseException {
        ...
        cvi.setIng_brutos((float) f.parse(formCVI.txtIngBrutos.getText()).doubleValue());
        
        cvi.setRet_iva((float) f.parse(formCVI.txtRetIva.getText()).doubleValue());
        
        cvi.setImp_r_ing_brutos((float) f.parse(formCVI.txtImpRIngBrutos.getText()).doubleValue());
    ...
    public void setearCamosEnCero() {
        ...
        formCVI.txtIngBrutos.setText("0");
        formCVI.txtRetIva.setText("0");
        formCVI.txtImpRIngBrutos.setText("0");
    }
