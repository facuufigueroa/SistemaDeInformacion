...
public class ReporteElRocioT {
   
    public void openReportElRocio(Date fecha_desde, Date fecha_hasta){
        try {
            ...
            jasperMasterReport = (JasperReport) JRLoader.loadObject(getClass().getResource("/Reportes/ElRocioT.jasper"));
            ...
            reporteMaster.setTitle(" El Rocio Transacciones - Informe ");
