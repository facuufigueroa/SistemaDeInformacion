...
public class ReporteJMRT {
  
    public void openReportJMRTransacciones(double total_entradas, double total_salidas,Date fecha_desde, Date fecha_hasta){
        try {
            ...
            jasperMasterReport = (JasperReport) JRLoader.loadObject(getClass().getResource("/Reportes/JMR-Transacciones.jasper"));
            ...
            reporteMaster.setTitle("JMR TRANSACCIONES");
