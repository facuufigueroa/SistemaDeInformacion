...
public class ReportByT {

    public void openReportByT(Date fecha_desde, Date fecha_hasta) {
        try {
            ...
            jasperMasterReport = (JasperReport) JRLoader.loadObject(getClass().getResource("/Reportes/Bancos y Tarjetas.jasper"));
            ...
            reporteMaster.setTitle(" Bancos y Tarjetas ");
