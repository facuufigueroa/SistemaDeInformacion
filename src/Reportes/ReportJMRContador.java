...
public class ReportJMRContador {
    
    public void openReportJMRContador(Date fecha_desde, Date fecha_hasta){
        try {
            ...
            jasperMasterReport = (JasperReport) JRLoader.loadObject(getClass().getResource("/Reportes/JMR-Contador.jasper"));
