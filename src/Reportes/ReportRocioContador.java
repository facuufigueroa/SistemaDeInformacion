...
public class ReportRocioContador {
    
    public void openReportElRocioContador(Date fecha_desde, Date fecha_hasta){
        try {
            ...
            jasperMasterReport = (JasperReport) JRLoader.loadObject(getClass().getResource("/Reportes/ElRocioContador.jasper"));
            ...
            reporteMaster.setTitle(" El Rocio - Informe para Contador ");
