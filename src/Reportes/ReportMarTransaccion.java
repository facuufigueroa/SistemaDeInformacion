...
public class ReportMarTransaccion {
    
    public void openReportMarTransacciones(Date fecha_desde, Date fecha_hasta){
        try {
            ...
            jasperMasterReport = (JasperReport) JRLoader.loadObject(getClass().getResource("/Reportes/MAR-Transacciones.jasper"));
            ...
            reporteMaster.setTitle(" M.A.R Transacicones - Informe ");
