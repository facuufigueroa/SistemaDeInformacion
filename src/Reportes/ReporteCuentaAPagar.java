...
public class ReporteCuentaAPagar {
     
    
    public void openReportCuentasAPagar(double total_entradas, double total_salidas,Date fecha_desde, Date fecha_hasta){
        try {
            ...
            jasperMasterReport = (JasperReport) JRLoader.loadObject(getClass().getResource("/Reportes/Cuentas-A-Pagar.jasper"));
            ...
            reporteMaster.setTitle(" Cuentas a Pagar ");
